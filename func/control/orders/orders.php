...
?>
                    ...
                    <div class="col-md-7 col-lg-12">
                        <div class="card shadow">
                            <div class="card-body">
                                <h4 class="m-t-0 header-title"><b><i class="fa fa-edit"></i>Ubah Pesanan</b></h4>
                                <br />
										<?php 
										if ($msg_type == "success") {
										?>
...
<?php } } else { ?><? } ?>
												...
												<div class="icon-contain">
													<div class="row">
														...
														<div class="col-10 text-right">
															<h5 class="mt-0 mb-1">Rp <?php echo number_format($data_worder['total'],0,',','.'); ?> (<?php echo number_format($count_worder,0,',','.'); ?>)
									   						<p class="mb-0 font-12 text-muted">Pembelian Pengguna</p>
														</div>
													</div>
												</div>
											</div>
		...
		<div class="card shadow">
                                <div class="card-body">
                                    <h5 class="m-0 "><i class="mdi mdi-cart"></i> Kelola Pesanan</h5>
				<hr>
