                ...
                <div class="row">
                    <div class="col-md-7">
                        <div class="card shadow">
                            <div class="card-body">
                                <h4 class="m-t-0 header-title"><b><i class="mdi mdi-"></i>Ubah Layanan</b></h4>
                                <br />
										<?php 
										if ($msg_type == "success") {
										?>
...
<?php } } else { ?><? } ?>
                <div class="col-md-5">
                        <div class="card shadow">
                                    <div class="card-body">
                                        <h4 class="m-t-0 header-title"><b><i class="mdi mdi-"></i>Kelola Layanan</b></h4>
                                        <br />
											<a href="?<?php echo paramEncrypt('control=delete-services')?>" class="btn btn-danger"><i class="fa fa-trash"></i> Hapus </a>
											<a href="?<?php echo paramEncrypt('control=add-services')?>" class="pull-right btn btn-primary"><i class="fa fa-plus"></i> Tambah </a>
				<br />						<br>
