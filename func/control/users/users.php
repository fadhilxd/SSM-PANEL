...
if (isset($_POST['edit'])) {
	...
	if (empty($post_email) || empty($post_username) || empty($post_status) || empty($post_password) || empty($post_balance) || empty($post_level)) {
		...
		if(password_verify($post_password, $data_user['password'])) {
			...
			if ($update_user == TRUE) {
				$msg_type = "success";
				$msg_content = "<b>Berhasil:</b> Pengguna berhasil diubah.<br /><b>Email:</b> $post_email<br /><b>Username:</b> $post_username<br /><b>Password:</b> $post_password<br /><b>Level:</b> $post_level<br /><b>Status:</b> $post_status<br /><b>Saldo:</b> Rp ".number_format($post_balance,0,',','.');
			} else {
				$msg_type = "error";
                ...
                <div class="row">
                    <div class="col-md-7">
                        <div class="card shadow">
                            <div class="card-body">
                                <h4 class="m-t-0 header-title"><b><i class="mdi mdi-account"></i>Ubah Pengguna</b></h4>
                                <br />
										<?php 
										if ($msg_type == "success") {
										?>
...
<?php } } else { ?><? } ?>
                    ...
                    <div class="col-md-5">
                        <div class="card shadow">
                                    <div class="card-body">
                                        <h4 class="m-t-0 header-title"><b><i class="mdi mdi-account"></i>Kelola Pengguna</b></h4>
                                        <br />
											<a href="?<?php echo paramEncrypt('control=delete-users')?>" class="btn btn-danger"><i class="fa fa-trash"></i> Hapus User</a>
											<a href="?<?php echo paramEncrypt('control=add-users')?>" class="pull-right btn btn-primary waves-effect w-md waves-light"><i class="fa fa-plus"></i> Tambah User</a></center><br><br>
